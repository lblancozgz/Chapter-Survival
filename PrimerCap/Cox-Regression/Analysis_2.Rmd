...
palafolls_clima <- 
  read_excel("C:\\Users\\lblan\\OneDrive\\Escritorio\\CEAB\\2022\\First_chapter\\Palafolls_clima_total.xlsx", 
    col_types = c("date", "numeric", "numeric"))
...
photoperiod$dates <- as.character(as.Date(photoperiod$dates, 
                                          format = '%Y-%m-%d'))
ddfield$start_date <- as.character(as.Date(ddfield$start_date, 
                                          format = '%Y-%m-%d'))
...
#with DATAFIELD
ddfield[ , 'photoperiod'] <- 0 # new column called photoperiod
vars2 <- c('photoperiod')
for(d in unique(photoperiod$dates)){
  ddfield[ddfield$start_date == d,vars2] <-
    photoperiod[photoperiod$dates == d, vars2]
}
...
#mwimin
rr<- coxph(formula = Surv(total_lived, censored) ~ mwimin, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ mwimin, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))

#mwimean
rr<- coxph(formula = Surv(total_lived, censored) ~ mwimean, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ mwime, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))

#mwimax
rr<- coxph(formula = Surv(total_lived, censored) ~ mwimax, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ mwimax, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))

#method
rr<- coxph(formula = Surv(total_lived, censored) ~ method, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ method, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


#location
rr<- coxph(formula = Surv(total_lived, censored) ~ location, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ location, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))

#mintemperature
rr<- coxph(formula = Surv(total_lived, censored) ~ mintemperature, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ mintemperature, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))

#maxtemperature
rr<- coxph(formula = Surv(total_lived, censored) ~ maxtemperature, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ maxtemperature, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))

#maxrh
rr<- coxph(formula = Surv(total_lived, censored) ~ maxrh, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ maxrh, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))

#minrh
rr<- coxph(formula = Surv(total_lived, censored) ~ minrh, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ minrh, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))

#daily_acc_gdd
rr<- coxph(formula = Surv(total_lived, censored) ~ daily_acc_gdd, data = ddfield)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


rr<- coxph(formula = Surv(total_lived, censored) ~ daily_acc_gdd, data = new_df_gdd)
cox.zph(rr)
ggcoxzph(cox.zph(rr))


#in our models 3...
Model3df<- coxph(formula = Surv(total_lived, censored) ~ photoperiod + mwimax, data = new_df_gdd)
cox.zph(Model3df)
ggcoxzph(cox.zph(Model3df))

Model3df<- coxph(formula = Surv(total_lived, censored) ~ photoperiod + mwimax, data = ddfield)
cox.zph(Model3df)
ggcoxzph(cox.zph(Model3df))
