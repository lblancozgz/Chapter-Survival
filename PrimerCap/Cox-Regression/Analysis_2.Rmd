...
t = cbind(new_df_gdd$id_mosquito, new_df_gdd$`hl/bg`, new_df_gdd$location, new_df_gdd$maxtemperature,
      new_df_gdd$mintemperature, new_df_gdd$minrh, new_df_gdd$maxrh, new_df_gdd$photoperiod,
      new_df_gdd$mwimax, new_df_gdd$mwimin)
colnames(t) <- c("id_mosquito", "`hl/bg`", "location", "maxtemperature", "mintemperature", "minrh",
              "maxrh", "photoperiod", "mwimax", "mwimin")
